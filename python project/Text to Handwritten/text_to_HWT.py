...
enter_text_lbl = tk.Label(windo, text="Enter your text", width=15, height=2, fg="#00FF89",bg="black",
                font=('segou UI', 16, ' bold'))
...
conv_text_lbl = tk.Label(windo, text="Enter your text", width=15, height=2, fg="#00FF89",bg="black",
                font=('segou UI', 16, ' bold'))
