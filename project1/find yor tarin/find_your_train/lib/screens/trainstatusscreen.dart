        ...
        body: Container(
            ...
            child: Container(
              ...
              children: <Widget>[
                ...
                Container(
                  color: Color.fromARGB(255, 147, 186, 252),
    ...
    if (traindata == null) {
      ...
      return Scaffold(
        floatingActionButton: FloatingActionButton(
            backgroundColor: Color.fromARGB(255, 147, 186, 252),
            onPressed: () {
              getRailwayData();
            },
              ...
              child: Column(children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Card(
                      shadowColor: Color.fromARGB(255, 147, 186, 252),
                      elevation: 10,
                      margin: EdgeInsets.all(20),
                      child: Column(
                        children: [
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Card(
                                  elevation: 10,
                                  shadowColor:
                                      Color.fromARGB(255, 147, 186, 252),
                                  child: Container(
                                      height: 50,
